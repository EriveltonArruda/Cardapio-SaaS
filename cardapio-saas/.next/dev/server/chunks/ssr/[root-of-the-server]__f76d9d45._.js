...
;
const SUPABASE_URL = ("TURBOPACK compile-time value", "https://gcrvepebkhebtomzwkqh.supabase.co");
const SUPABASE_KEY = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdjcnZlcGVia2hlYnRvbXp3a3FoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzMxNDk4MjIsImV4cCI6MjA4ODcyNTgyMn0.P37IdWJgdLm-eV5L-B2g5GIY1LbYkPpFROShWzSVxKI");
...
function AuthProvider({ children }) {
    ...
    const checkAdminRole = async (userId)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("user_roles").select("role").eq("user_id", userId).eq("role", "admin").maybeSingle();
        if (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange(async (event, newSession)=>{
        ...
        const initSession = async ()=>{
            const { data: { session: currentSession } } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
            if (currentSession) {
    ...
    const signIn = async (email, password)=>{
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email,
            password
        });
        return {
    ...
    const signUp = async (email, password)=>{
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password,
            options: {
                emailRedirectTo: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ''
            }
        });
        return {
            error: result.error,
...
"[project]/src/contexts/StoreContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StoreProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadStoreData() {
            ...
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('stores').select('*').eq('slug', slug).single();
...
function CartProvider({ children }) {
    ...
    const addToCart = (product, quantity, selectedAddons, observations)=>{
        setItems((prev)=>{
            const existingItemIndex = prev.findIndex((item)=>item.product.id === product.id && item.observations === observations);
    ...
    const addAddonToItem = (productId, addon)=>{
        setItems((prev)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f76d9d45._.js.map